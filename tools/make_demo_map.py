...
# BGR
RED, ORANGE, MAGENTA = (0, 0, 255), (0, 128, 255), (255, 0, 255)
BLUE, YELLOW, CYAN = (255, 0, 0), (0, 255, 255), (255, 255, 0)
GREEN, PARK, WATER, PLAZA, PARKING = (0, 255, 0), (0, 128, 0), (255, 128, 0), (255, 128, 255), (255, 0, 128)
ELEVATED = (128, 0, 255)
...
def main():
    ...
    a = np.zeros((H, W), np.uint8)  # 标记层 alpha
    ...
    # ---- 道路 ----
    o, rw = 130, 120                      # 环路: 约 22m，双向六车道
    R(o, o, W - 2 * o, rw, BLUE)
    R(o, H - o - rw, W - 2 * o, rw, BLUE)
    R(o, o, rw, H - 2 * o, BLUE)
    R(W - o - rw, o, rw, H - 2 * o, BLUE)
    R(o, 1010, W - 2 * o, 180, BLUE)      # 东西向主干路: 约 32m，双向八车道（上面压着高架）
    ...
    # 环岛: A 与北侧支路相交处，画一个圆环即可
    disc(924, 644, 118, BLUE)
    disc(924, 644, 52, (0, 0, 0), on=0)
    # 高架: 盖在主干路正上方，两端伸出环路
    ...
    R(295, 925, 200, 40, ORANGE)
    # 中北上: 带内院的大商场（避开左下角的环岛）
    R(1090, 295, 565, 280, RED)
    clear(1260, 380, 220, 110)
    # 中北下: 两栋商铺 + 小广场
    R(1090, 713, 250, 250, RED)
    R(1380, 713, 275, 120, RED)
    R(1380, 850, 275, 113, PLAZA)
    # 东北: 公园 + 水池
    R(1825, 295, 430, 670, PARK)
    cv2.ellipse(mk, (2040, 600), (130, 190), 15, 0, 360, WATER, -1)
    cv2.ellipse(a, (2040, 600), (130, 190), 15, 0, 360, 255, -1)
    # 最东北: 三栋住宅高楼 + 绿地
    ...
    # ---- 南半区 ----
    # 西南: 大商场 + 停车场
    R(295, 1235, 560, 300, RED)
    R(295, 1590, 560, 315, PARKING)
    # 中南上: U 形商铺围着广场
    R(993, 1235, 130, 280, RED)
    R(1123, 1385, 402, 130, RED)
    R(1525, 1235, 130, 280, RED)
    R(1123, 1235, 402, 150, PLAZA)
    # 中南下: 一排商铺 + 单层铺
    ...
    # 整体旋转 6°（带抗锯齿），再叠到底图上
    M = cv2.getRotationMatrix2D((W / 2, H / 2), 6, 0.9)
    ...
    img = (mk * a + base * (1 - a)).astype(np.float32)
